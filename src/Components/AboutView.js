      ...
      <div className="container mx-auto flex flex-col px-5 py-8 justify-center items-center">
        <picture className={"flex justify-center items-center"}>
          ...
          <img
            ...
            alt="Federico Tartarini's picture'"
          />
        </picture>
        <div className="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
          ...
          <p className="leading-relaxed">
            ...
            that can be used to download the data in real-time. In addition, I
            would like to thank the developers at OpenStreetMap, Leaflet, React,
            FontAwesome, Inkscape and Google. I could now have created Dengue
            Singapore without their amazing work.
          </p>
          <p>
